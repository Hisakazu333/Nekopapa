...
Rectangle {
    ...
    y: 0
    radius: 30
    color: Theme.isDark ? Theme.alpha("surface.float", 0.98) : Theme.alpha("surface.base", 0.96)
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            radius: 20
            color: Theme.alpha("surface.sunken", Theme.isDark ? 0.72 : 0.86)
    ...
    component SliderRow: ColumnLayout {
        ...
        RowLayout {
            ...
            Slider {
                ...
                to: parent.parent.to
                value: parent.parent.initialValue
                onMoved: parent.parent.sliderMoved(sliderCtrl.value)
            }
            Text {
